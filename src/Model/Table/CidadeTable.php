...
class CidadeTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('cidade');
        $this->displayField('cod_cidade');
        $this->primaryKey('cod_cidade');
    }
    ...
    {
        $validator
            ->integer('estado_cod_estado')
            ->requirePresence('estado_cod_estado', 'create')
            ->notEmpty('estado_cod_estado');

        $validator
            ->integer('cod_cidade')
            ->allowEmpty('cod_cidade', 'create');
